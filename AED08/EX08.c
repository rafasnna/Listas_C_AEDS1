...
/**
 * printArray - mostra arranjo com valores inteiros
...
{//definir dado local (provavelmente na memoria)
...
int main(){
    int opcao = 0;
        printf("%s\n", "Exemlo0200 - Programa = v0.0");
        printf("%s\n", "Autor:____________ = v0.0");
        printf("\n");
